  ...
  return (
    <div className="min-h-screen bg-[#f1f5f9] p-6 md:p-10">
      ...
      <div className="flex flex-col md:flex-row justify-between items-center mb-10 gap-5">
        <div>
          <h1 className="text-4xl font-black text-slate-900">Rider Dashboard</h1>
      ...
      <RiderOrders orders={orders} updateOrderStatus={updateOrderStatus} />
