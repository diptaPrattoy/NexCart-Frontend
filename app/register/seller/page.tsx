...
export default function SellerRegisterPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-green-50 px-4 py-10">
      <div className="w-full max-w-2xl bg-white border border-gray-200 rounded-2xl shadow-xl p-6 sm:p-10">
        {/* HEADER */}
        <div className="text-center mb-8">
          <div className="w-14 h-14 mx-auto bg-green-600 text-white rounded-xl flex items-center justify-center text-xl font-bold">
            🏪
          </div>
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
          {[
            ...
            <div key={key}>
              <input
                ...
                placeholder={label}
                {...register(key as any)}
                className="w-[100%]  px-4 py-3 border rounded-lg outline-none focus:ring-2 focus:ring-green-500 bg-white text-gray-900"
              />
              {errors[key as keyof SellerRegisterData] && (
                <p className="text-red-500 text-sm mt-1">
                  {errors[key as keyof SellerRegisterData]?.message as string}
                </p>
              )}
            </div>
          ))}
          ...
          {/* FILE UPLOAD */}
          <div>
            <label className="block w-full cursor-pointer border border-gray-300 rounded-lg px-4 py-3 text-center hover:border-green-500 transition">
              Upload NID Image
              <input
                type="file"
                accept="image/*"
            ...
            {errors.nidImage && (
              <p className="text-red-500 text-sm mt-1">
                {errors.nidImage.message as string}
              </p>
            )}
          </div>
        ...
        <p className="text-center text-sm text-gray-600 mt-6">
          ...
          <Link href="/login/seller" className="text-green-600 font-bold">
            Login
          </Link>
        </p>
      </div>
